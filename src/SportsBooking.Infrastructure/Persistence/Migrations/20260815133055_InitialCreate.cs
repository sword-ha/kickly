        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<decimal>(type: "decimal(10,7)", precision: 10, scale: 7, nullable: false),
                    Longitude = table.Column<decimal>(type: "decimal(10,7)", precision: 10, scale: 7, nullable: false),
                    DayPricePerHour = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    NightPricePerHour = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FieldAmenities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FieldAmenities_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_FieldId_BookingDate",
                table: "Bookings",
                columns: new[] { "FieldId", "BookingDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_FieldId",
                table: "Favorites",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_FieldId",
                table: "Favorites",
                columns: new[] { "UserId", "FieldId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FieldAmenities_FieldId",
                table: "FieldAmenities",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldAvailabilities_FieldId_Date",
                table: "FieldAvailabilities",
                columns: new[] { "FieldId", "Date" },
                unique: true);
